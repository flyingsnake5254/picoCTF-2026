- [1. 基本語法](#1-基本語法)
- [2. 列出主機上的分享](#2-列出主機上的分享)
- [3. 連線到分享](#3-連線到分享)
- [4. 瀏覽檔案](#4-瀏覽檔案)
  - [列出遠端檔案 - ls](#列出遠端檔案---ls)
  - [查看目前遠端路徑 - pwd](#查看目前遠端路徑---pwd)
  - [進入目錄 - cd](#進入目錄---cd)
  - [回到上一層 - cd ..](#回到上一層---cd-)
  - [查看命令清單 - help](#查看命令清單---help)
- [5. 下載檔案](#5-下載檔案)
  - [下載單一檔案](#下載單一檔案)
  - [指定本機檔名](#指定本機檔名)
  - [查看本機目前路徑](#查看本機目前路徑)
...
- [7. 上傳檔案](#7-上傳檔案)
  ...
  - [上傳多個檔案](#上傳多個檔案)
- [8. 非互動模式](#8-非互動模式)
  - [使用 -c 直接執行 smbclient 命令](#使用--c-直接執行-smbclient-命令)
  - [下載檔案](#下載檔案)
  - [進入目錄再下載](#進入目錄再下載)
  - [一次下載多個檔案](#一次下載多個檔案)
  - [使用者帳號](#使用者帳號)
- [9. 特殊分享名稱](#9-特殊分享名稱)
- [10. 指定網域或工作群組](#10-指定網域或工作群組)
- [11. 指定 SMB 協定版本](#11-指定-smb-協定版本)
- [12. 主機名稱無法解析](#12-主機名稱無法解析)
- [13. 除錯輸出](#13-除錯輸出)
- [14. 常見錯誤](#14-常見錯誤)
  - [NT\_STATUS\_LOGON\_FAILURE](#nt_status_logon_failure)
  - [NT\_STATUS\_ACCESS\_DENIED](#nt_status_access_denied)
  - [NT\_STATUS\_BAD\_NETWORK\_NAME](#nt_status_bad_network_name)
  - [Connection refused](#connection-refused)
  - [協定版本錯誤](#協定版本錯誤)
- [15. CTF 標準探查流程](#15-ctf-標準探查流程)
- [16. 安裝方式](#16-安裝方式)
